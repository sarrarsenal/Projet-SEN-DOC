...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Precedent"},
sEmptyTable:"Pas de donnee trouvee",sInfo:"Trouve _START_ de _END_ sur _TOTAL_ lignes",sInfoEmpty:"Trouve 0 de 0 sur 0 lignes",sInfoFiltered:"(filtre de _MAX_ total lignes)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"afficher _MENU_ lignes",sLoadingRecords:"Loading...",sProcessing:"Processing...",ssearch:"rechercher:",ssearchPlaceholder:"",sUrl:"",sZeroRecords:"Pas de resultat"},osearch:h.extend({},p.models.osearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
